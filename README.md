...
- Work your way through the tasks in [index.js](index.js). Don't worry about that fact that you can't see the arrays or items in this file; they can all be found within the index.test.js file where the functions are actually called.
